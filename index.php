...
<html lang="en">
	...
	<!-- Back to top button -->
			...
			<div>
				<?php
                    if(isset($_SESSION['u_id'])) {
						...
						<button type="reset" onclick="document.location=\'signup.php\'">Sign up</button>
						</form>';
                    }
				?>
				<?php
		...
		<div id="home">
				...
				<div class="hero">
					<div class="default-width">
						...
						<!-- Right: hero image -->
						<div>
							<img src="assets/hero.png" alt="header image" />
						</div>
					</div>
				</div>
			</div>
		...
		<section class="sponsors">
			<div>
				<img src="assets/client-1.png" alt="client-1 logo" />
				<img src="assets/client-2.png" alt="client-2 logo" />
				<img src="assets/client-3.png" alt="client-3 logo" />
				<img src="assets/client-4.png" alt="client-4 logo" />
				<img src="assets/client-5.png" alt="client-5 logo" />
			</div>
		</section>
			...
			<div class="default-width">
				...
				<div class="cards">
					<div class="cards-item anim01">
						<img src="assets/leaf.png" alt="leaf image" />
		...
		<section class="you-need">
			<div class="default-width">
				<div class="left">
					...
					<div>
						<img src="assets/leaf_white.png" alt="leaf image" />
						<h4>100% Organic</h4>
						<h6>Cobbler's pose, bound angle pose staff pose bow.</h6>
					</div>
					<div>
				...
				<div class="right">
					<img src="assets/hero-2.png" alt="hero-2 image" />
				</div>
			</div>
		</section>
			...
			<div class="default-width">
				...
				<div class="slider">
					<div class="slider__item">
						<img src="assets/blog-1.png" alt="blog-1 image" />
						<h5>8 Easy Pieces I’ve Worn Over & Over to Have it All</h5>
						<h6>David Beck <i class="fas fa-circle"></i> April 13, 2019</h6>
					</div>
					<div class="slider__item">
						<img src="assets/blog-2.png" alt="blog-2 image" />
						<h5>8 Easy Pieces I’ve Worn Over & Over to Have it All</h5>
						<h6>David Beck <i class="fas fa-circle"></i> April 13, 2019</h6>
					</div>
					<div class="slider__item">
						<img src="assets/blog-3.png" alt="blog-3 image" />
						<h5>8 Easy Pieces I’ve Worn Over & Over to Have it All</h5>
						<h6>David Beck <i class="fas fa-circle"></i> April 13, 2019</h6>
					</div>
					<div class="slider__item">
						<img src="assets/blog-4.png" alt="blog-4 image" />
						<h5>8 Easy Pieces I’ve Worn Over & Over to Have it All</h5>
						<h6>David Beck <i class="fas fa-circle"></i> April 13, 2019</h6>
					</div>
					<div class="slider__item">
